...
class _RawBurak extends LeafRenderObjectWidget {
  const _RawBurak(
    this.mainAxisExtent, {
    this.crossAxisExtent,
    this.color,
  ...
  @override
  void updateRenderObject(BuildContext context, RenderBurak renderObject) {
    renderObject
      ..mainAxisExtent = mainAxisExtent
      ..crossAxisExtent = crossAxisExtent ?? 0
      ..color = color
...
class RenderBurak extends RenderBox {
  RenderBurak({
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    ...
    if (direction != null) {
      ...
      throw FlutterError(
        'A Burak widget must be placed directly inside a Flex widget '
